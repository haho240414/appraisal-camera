...
- 앱은 인터넷 권한, 위치 권한, 연락처 권한, 마이크 권한, 전화 권한을 요청하지 않습니다.
- 앱 데이터 백업은 비활성화되어 있습니다.
- 외부 앱으로 공유하는 파일은 FileProvider를 통해 제한된 캐시 경로만 임시 공유합니다.
- Play Store / 릴리즈 빌드는 R8 난독화와 리소스 축소를 사용해 APK/AAB 역공학을 어렵게 합니다.
